...
img = cv.imread('traffic-light.jpg')

redLightOn = ([45, 37, 232], [122, 104, 255])
yellowLightOn = ([7, 50, 242], [34, 249, 255])
greenLightOn = ([124, 135, 11], [170, 177, 80])
...
def isLightOn(image, range):
    ...
    blur = cv.GaussianBlur(imMask, (19,19), 0)
    (_, thresh) = cv.threshold(blur, 2, 255, cv.THRESH_BINARY)
